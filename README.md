...
Минимальный набор инструментов, который нужен для создания своего [видеоплеера](https://shadowsking.github.io/video-player-jslib/). Все элементы можно кастомизировать на свой вкус и цвет.
